...
// Local project extension: makes i2s_config_t.mclk_multiple configurable, e.g.
// -DAUDIO_TOOLS_I2S_MCLK_MULTIPLE=I2S_MCLK_MULTIPLE_384 for codecs that expect
// a 384x master clock. Defining I2S_MCLK_MULTIPLE_DEFAULT directly is not
// possible because IDF declares it as an enum constant.
#ifndef AUDIO_TOOLS_I2S_MCLK_MULTIPLE
#  define AUDIO_TOOLS_I2S_MCLK_MULTIPLE I2S_MCLK_MULTIPLE_DEFAULT
#endif
 ...
 protected:
  ...
  bool begin(I2SConfigESP32 cfg, int txPin, int rxPin) {
    ...
    i2s_config_t i2s_config_new = {
        ...
        .mclk_multiple = AUDIO_TOOLS_I2S_MCLK_MULTIPLE,
